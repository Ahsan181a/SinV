        ...
        <div class="card card-primary card-outline">
          <div class="card-body">
            <h5 class="card-title">List Category</h5><br>
              <a href="{{route('categories.create')}}" class="btb-sm btn btn-primary"><i class="fa fa-plus"></i>Add category</a>
            <br>
            <table class="table table-bordered myTable">
              ...
              <tbody>
                ...
                <tr class="text-center">
                  ...
                  <td>{{$category->name??''}}</td>
                  <td>
                    <a href="{{route('categories.edit',$category->id)}}" class="btb-sm btn btn-primary" title="Edit"><i class="fas fa-pen"></i>Edit</a>
